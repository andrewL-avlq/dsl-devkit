...
,'»"«g.name»" //«ENDFOR»
        ...
        public Injector doSetup(Module overrideModule, Module... additionalModules) {
          return new «lspBuildSetupGeneratedClass.simpleName»(SETUP_LOCK, overrideModule, additionalModules).createInjectorAndDoEMFRegistration();
        }
        ...
        public String getLanguageName() {
          return «lspBuildSetupGeneratedClass.simpleName».GRAMMAR;
        }
  ...
  def generateBuildSetup() {
    fileAccessFactory.createJavaFile(getLspBuildSetupGeneratedClass, '''
      ...
      public class «lspBuildSetupGeneratedClass.simpleName» extends «packageNaming.getGenericIdeSetup(grammar)» {
        ...
        @SuppressWarnings("nls")
        static final String GRAMMAR = "«grammar.name»";
        ...
        public void register(final Injector injector) {
          ...
          Resource.Factory.Registry.INSTANCE.getContentTypeToFactoryMap().put(GRAMMAR, resourceFactory);
          IResourceServiceProvider.Registry.INSTANCE.getContentTypeToFactoryMap().put(GRAMMAR, serviceProvider);
        }
      }
    ''').writeTo(projectConfig.genericIde.srcGen)
  }
